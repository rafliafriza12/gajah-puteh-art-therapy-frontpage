...
import { SupportingDocument } from "@/types/supportingDocument";
...
const SupportingDocumentsContent = () => {
  const mockDocuments: SupportingDocument[] = [
    {
      id: "1",
      documentName: "Corporate Governance Policy 2024",
    ...
    {
      id: "2",
      documentName: "Board Charter and Responsibilities",
      documentType: "Board Manuals",
      lastUpdated: "24/10/2025",
      isPublished: true,
    },
    {
      id: "3",
      documentName: "Code of Business Conduct and Ethics",
    ...
    {
      id: "4",
      documentName: "Articles of Association Updated 2024",
    ...
    {
      id: "5",
      documentName: "Audit Committee Guideline",
    ...
    {
      id: "6",
      documentName: "Environmental Policy Statement",
      documentType: "Policies",
      lastUpdated: "22/10/2025",
      isPublished: true,
    },
    {
      id: "7",
      documentName: "Risk Management Framework",
      documentType: "Board Manuals",
    ...
    {
      id: "8",
      documentName: "Whistleblowing Guidelines",
      documentType: "Code of Conduct",
      lastUpdated: "21/10/2025",
      isPublished: true,
    },
  ...
  const [documents, setDocuments] =
    useState<SupportingDocument[]>(mockDocuments);
  const [activeTab, setActiveTab] = useState<(typeof tabs)[number]>("Policies");
  const [selectedDocuments, setSelectedDocuments] = useState<string[]>([]);
  const [searchQuery, setSearchQuery] = useState("");
  const [currentPage, setCurrentPage] = useState(1);
  const [itemsPerPage, setItemsPerPage] = useState(10);
  const [sortConfig, setSortConfig] = useState<{
    key: keyof SupportingDocument | null;
    direction: "asc" | "desc";
  }>({ key: null, direction: "asc" });

  const filteredDocuments = useMemo(() => {
    return documents.filter((doc) => {
      const matchesTab = doc.documentType === activeTab;
  ...
  const handleSort = (key: keyof SupportingDocument) => {
    setSortConfig((prev) => ({
      key,
  ...
  return (
    <div className="bg-neutral-01 rounded-lg border border-grey-stroke p-6">
...
export default SupportingDocumentsContent;
