...
import { CorporateAction } from "@/types/corporateAction";
...
const CorporateActionContent = () => {
  const mockDocuments: CorporateAction[] = [
    {
      id: "1",
      documentName: "Mandatory Convertible Bonds (OWK)",
      lastUpdated: "24/10/2025",
      isPublished: true,
    },
    {
      id: "2",
      documentName: "Trustee Agreement of BUMI OWK",
      lastUpdated: "24/10/2025",
      isPublished: true,
    },
    {
      id: "3",
      documentName: "Notice for Calling RUPO 5 November 2019",
      lastUpdated: "24/10/2025",
      isPublished: true,
    },
    {
      id: "4",
      documentName: "Results Announcement of RUPO 5 November 2019",
      lastUpdated: "23/10/2025",
      isPublished: true,
    },
    {
      id: "5",
      documentName: "First Amendment Trustee Agreement of BUMI OWK",
      lastUpdated: "23/10/2025",
      isPublished: true,
    },
  ];

  const [documents, setDocuments] = useState<CorporateAction[]>(mockDocuments);
  const [selectedDocuments, setSelectedDocuments] = useState<string[]>([]);
  const [searchQuery, setSearchQuery] = useState("");
  const [currentPage, setCurrentPage] = useState(1);
  const [itemsPerPage, setItemsPerPage] = useState(5);
  const [sortConfig, setSortConfig] = useState<{
    key: keyof CorporateAction | null;
    direction: "asc" | "desc";
  ...
  const handleSort = (key: keyof CorporateAction) => {
    setSortConfig((prev) => ({
      key,
...
export default CorporateActionContent;
